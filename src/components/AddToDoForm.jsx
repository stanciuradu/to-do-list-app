        ...
        return(
            <div className='add-to-do-form'>
                <form onSubmit={(event)=>this.handleSubmitForm(event)}>
                    ...
                    <input type="text" id='title' onChange={(event)=>this.handleTitleChange(event)} value={this.state.title} className="form-control"/>
                    <label htmlFor="description">Description:</label>
                    <input type="text" id="description" onChange={(event)=>this.handleChangeDescription(event)} value={this.state.description} className="form-control"/>
                    <label htmlFor="date">Date:</label>
                    <input type="datetime-local" id="date" onChange={(event)=>this.handleChangeDate(event)} value={this.state.date} className="form-control" />
                    <input type="submit" value="Adauga task" className="btn btn-primary"/>
                </form>
            </div>
        );
    }
